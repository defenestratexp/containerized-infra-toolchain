#!/bin/bash
# network-debug container launcher
...
IMAGE_NAME="homelab-network-debug"
ECR_IMAGE="${ECR_REGISTRY}/homelab/network-debug:latest"
...
info "Starting network-debug container..."

# Note: Some tools (nmap, tcpdump) may need --cap-add NET_RAW or --privileged
# Build docker run command
DOCKER_CMD="docker run $DOCKER_FLAGS --rm --name network-debug-session"
DOCKER_CMD="$DOCKER_CMD --network host"
DOCKER_CMD="$DOCKER_CMD --cap-add NET_RAW"
