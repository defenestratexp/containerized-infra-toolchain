#!/bin/bash
# kubectl-k3s-main container launcher
...
IMAGE_NAME="homelab-kubectl-k3s-main"
ECR_IMAGE="${ECR_REGISTRY}/homelab/kubectl-k3s-main:latest"
...
info "Starting kubectl-k3s-main container..."

# Build docker run command
DOCKER_CMD="docker run $DOCKER_FLAGS --rm --name kubectl-k3s-main-session"
